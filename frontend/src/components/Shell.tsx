...
export default function Shell() {
  ...
  return (
    <QuickCaptureContext.Provider value={ctx}>
      <div className="relative flex h-full w-full bg-canvas text-ink">
        {/* thin accent scanline across the top */}
        ...
        <main className="relative min-w-0 flex-1 overflow-auto h-full">
          <Outlet />
        </main>
      </div>
