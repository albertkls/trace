          ...
          <div className="relative flex min-h-0 flex-1">
            ...
            >
              ...
              <div className="mt-auto space-y-3 border-t border-line px-2 pt-4">
                ...
                >
                  <span className="flex items-center gap-2">
                    <span className="text-accent">{resolvedTheme === "dark" ? "☾" : "☼"}</span>
                    <span>{resolvedTheme === "dark" ? "深色" : "浅色"}</span>
                  </span>
                  <span className="mono-meta">{preference === "system" ? "SYSTEM" : "THEME"}</span>
                </button>
                ...
                <button
                  ...
                  className="search-btn flex items-center gap-2 mono-meta transition hover:text-ink"
                >
            ...
            <main className="app-main relative h-full min-w-0 flex-1 overflow-auto">
              <Outlet />
            </main>
          </div>
        </div>
